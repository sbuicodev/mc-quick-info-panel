...
public class ToggleInfoOnKeypress extends EventHandler<ClientTickEvents.EndTick> {
    private static final KeyBinding keyBinding = KeyBindingHelper.registerKeyBinding(new KeyBinding("key.quickinfopanel.toggle", // The translation key of the keybinding's name
