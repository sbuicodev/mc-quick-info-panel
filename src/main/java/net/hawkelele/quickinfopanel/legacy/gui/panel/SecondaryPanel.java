...
import net.hawkelele.quickinfopanel.legacy.gui.coordinates.AlternateDimensionCoordinates;
    ...
    public void drawBiomeAndWeather(GuiGraphics context) {
        ...
        try (Level level = client.player.level()) {
            ...
            String translatedWeather = Utils.truncate(
                    Component.translatable("biomes." + QuickInfoPanel.MOD_ID + "." + biomeName).getString(),
                    16,
                    5);
