...
public enum PositionPresets {
    ...
    TOP_RIGHT(new GeneralSettings.Position("top-right", 200, 30, false, false, false, true, true, false)),
    BOTTOM_LEFT(new GeneralSettings.Position("bottom-left", 5, 40, false, false, false, false, false, true)),
    BOTTOM_RIGHT(new GeneralSettings.Position("bottom-right", 200, 40, false, false, false, false, true, true));
